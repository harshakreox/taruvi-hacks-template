# Welcome to Your Taruvi Hackathon Codespace

Your environment is ready. You need to do just two things.

---

## Step 1 — Paste your Taruvi credentials into .env

The `.env` file is open in a tab next to this one.

Go to your **Taruvi onboarding page (Step 7)** and copy these three values:

    TARUVI_SITE_URL=
    TARUVI_APP_SLUG=
    TARUVI_API_KEY=

Paste them into `.env` and save the file — **Ctrl+S** (Windows/Linux) or **Cmd+S** (Mac).
...
## If something did not happen automatically
